...
import {facilities, Facility} from "@/constants/data";
        ...
        <ScrollView showsVerticalScrollIndicator={false}
            ...
            <View className="relative w-full" style={{height: windowHeight / 2}}>
                <Image source={{uri: property?.image}}
                       className="size-full" resizeMode="cover"/>
                <Image source={images.whiteGradient}
                    ...
                    <View className="flex flex-row items-center w-full justify-between">
                        ...
                        <View className="flex flex-row items-center gap-3">
                            <Image source={icons.heart}
                                   className="size-7" tintColor={"#191D31"}/>
            ...
            <View className="px-5 mt-7 flex gap-2">
                    ...
                    {property?.facilities.length > 0 && (
                        <View className="flex flex-row flex-wrap items-start justify-start mt-2 gap-5">
                            {property?.facilities.map((item: string, index: number) => {
                                const facility = facilities.find((facility: Facility) => facility.title === item);
                ...
                {property?.gallery.length > 0 && (
                    <View className="mt-7">
                        ...
                        <FlatList horizontal data={property?.gallery}
